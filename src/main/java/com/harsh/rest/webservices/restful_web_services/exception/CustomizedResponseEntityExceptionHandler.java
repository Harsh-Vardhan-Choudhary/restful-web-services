...
import com.harsh.rest.webservices.restful_web_services.user.UserNotFoundException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler
{
    ...
    @ExceptionHandler(UserNotFoundException.class)      // handle UserNotFound exception
            ...
            (MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) 
    {
        ...
        //for getting specified message that is declared as default in user.java
